    ...
    <div class="card-body">
      ...
      <form id="clogin-frm" action="" method="post">
        ...
        <div class="row">
          ...
          <br>
      <center>
          <a class="tex-decoration-none" href="facebook/index.php">
              <img style="width:220px" src="uploads/fblogin.png" />
          </a>
          <br>
          <a class="tex-decoration-none" href="google/index.php">
              <img style="width:220px" src="uploads/google.png" />
          </a>
      </center>
      <?php
      if(isset($_GET['scl'])){
          echo '<input id="sc_email" name="sc_email" type="text" value="'.$_GET['scl'].'" hidden>';
      }
      ?>
      <!-- /.social-auth-links -->
...
<script>
    $(document).ready(function() {
        ...
        console.log(sc_email);
        $.ajax({
            url: _base_url_ + 'classes/Login.php?f=login_client&social_login=1',
            method: 'POST',
            data: {email: sc_email },
            dataType: 'json',
            error: err => {
